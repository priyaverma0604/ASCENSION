      ...
      <div className="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl mx-auto flex flex-col gap-10 sm:gap-16">
        ...
        <div className="text-center flex flex-col gap-3">
          ...
          <h1 className="font-serif text-3xl md:text-4xl font-bold tracking-wide text-charcoal-dark leading-tight flex justify-center">
            <img src={`${sevaLogo}?v=3`} alt="Ascension Seva" className="h-24 sm:h-28 md:h-36 w-auto object-contain" />
          </h1>
        ...
        <div className="glass p-8 rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-10 items-start border border-cream-dark/65">
          ...
          <div className="flex flex-col gap-4 text-left">
            ...
            <span className="font-cormorant text-[13px] text-gold-dark font-medium -mt-2 block">
            ...
            {/* Quote block */}
            <div className="mt-4 border-l-2 border-gold pl-4 py-1 text-charcoal-light leading-relaxed bg-cream-light/30 rounded-r-xl">
