                    ...
                    <div className="border-t border-cream-dark/65 pt-6 flex justify-between items-center font-sans mt-4">
                      ...
                      {isUserEnrolled ? (
                        <button
                          ...
                          className="bg-gold hover:bg-gold-dark text-charcoal-dark font-bold uppercase tracking-wider py-3 px-8 rounded-xl transition-all duration-300 text-xs shadow-sm flex items-center gap-1.5 group"
                        >
