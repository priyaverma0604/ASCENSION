...
const Footer = () => {
  ...
  return (
    <footer className="bg-cream-dark/40 pt-12 sm:pt-16 pb-8 border-t border-cream-dark/60 mt-16 sm:mt-20">
      <div className="max-w-7xl 2xl:max-w-screen-2xl 3xl:max-w-[1600px] mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
        ...
        <div className="flex flex-col gap-4 text-left">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <Link to="/webinars" className="text-xs text-charcoal-light hover:text-gold transition-colors duration-200">Upcoming Webinars</Link>
        ...
        <div className="flex flex-col gap-4 text-left">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2 text-xs text-charcoal-light">
              ...
              <a href="tel:+918929061557" className="hover:text-gold transition-colors">+91 89290 61557</a>
            </div>
            <div className="flex items-center gap-2 text-xs text-charcoal-light">
      ...
      {/* Divider */}
      <div className="max-w-7xl 2xl:max-w-screen-2xl 3xl:max-w-[1600px] mx-auto px-4 sm:px-6 md:px-12 my-6 sm:my-8 border-t border-cream-dark/60"></div>

      {/* Bottom Info & Disclaimer */}
      <div className="max-w-7xl 2xl:max-w-screen-2xl 3xl:max-w-[1600px] mx-auto px-4 sm:px-6 md:px-12 flex flex-col gap-4 font-sans">
